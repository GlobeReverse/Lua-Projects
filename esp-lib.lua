...
function main:Load()
    ...
    self.connection = RunService.RenderStepped:Connect(updateEsp)
end

function main:SetSetting(idx, value)
    ESP_SETTINGS[idx] = value
